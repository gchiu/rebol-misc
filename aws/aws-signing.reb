...
unsplit: function [ 
    ...
    len: either char? param [1][length param]
    loop len [take/last result]
    result
]
...
mcr: Make-Canonical-Request: function [req body][
    ...
    CanonicalRequest: collect [
        ...
        keep unsplit reduce [
        	CanonicalURI: default [copy "/"]
            either blank? CanonicalQueryString [copy ""][unsplit sort-query-string CanonicalQueryString "&"]
        	Make-CanonicalHeaders req 
        	unsplit SignedHeaders ";"
        	lc-hash body
        ] newline
    ]
